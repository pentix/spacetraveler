...
\HRule \\[0.4cm]
{ \huge \bfseries Spacetraveler}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
{\large 17. Februar 2016}\\[2cm] % Date, change the \today to a set date if you want to be precise
