...
Alle Objekte, auf die sich die sich die Gravitation im Spiel auswirken kann (sog. spaceObjects), befinden sich in einer Liste (\textit{spaceObjects})
...
Die Energieänderung berechnet sich wie folgt:
...
während wir diese Begriffe etwas unsauber mischen. Die Kraft, mit der sich 2 Objekte bekanntlich anziehen beträgt
...
unberechenbar und das Spiel somit nicht wirklich spielbar. 



\subsubsection{Der Spieler ist ein Raumschiff}
Der Spieler steuert sein Raumschiff, indem er es von den beschrieben Gravitationspunkten in eine Richtung ziehen oder stossen lässt.\\
