...
\begin{quote}
Der verrückte Wissenschaftler Dr. Lewinsky war mit seiner Rakete auf der Suche nach einem äusserst seltenen Element welches er zur Fertigung seiner Gravitationskanone benötigt. 
...
Deine Aufgabe ist es nun Dr. Lewinsky mithilfe der instabilen und ungetesteten Gravitationskanone nach Hause zu befördern. 
...
Hier auf der Erde kennen wir das Phänomen der Schwerkraft, welches eigentlich die Gravitationskraft der Erde auf uns ist.
Das Problem mit den Effekten der Schwerkraft auf der Erde ist, dass wir immer von Objekten sprechen, die eine erheblich kleinere Masse als die Erde haben.
In unserem Spiel wollten wir genau das verhindern, damit keine Art von Schwerkraft bestehe, sondern einzelne Objekte von ähnlicher Masse wie der Spieler, diesen anziehen.
So treten in unserem Spiel Phänomene Astronomischer Art auf.
Die Bahnen, die der Spieler macht, wenn er sich solchen Gravitationspunkten nähert, haben eine elliptische Form.
...
...
\section{Entwurf}
\vspace{0.3cm}
\includegraphics[height=0.85\textwidth,angle=90]{uml.png}
