...
public class Game {
	...
	private static boolean gravLeft = false; 		/**< @brief Wird linke Maustaste gedr¸ckt?*/
	private static boolean gravRight = false; 		/**< @brief Wird rechte Maustaste gedr¸ckt?*/
	...
	/**
	 * @brief Kollisions¸berpr¸fung und elastischer Stoss
	 * @param spaceObjects 
	 */
