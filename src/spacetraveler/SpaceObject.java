...
/**
 * 
 * @brief Superklasse f√ºr alle Objekte, die sich auf dem Bildschirm bewegen k√∂nnen.
 * 
 * Die Klasse vereint unser Model (SpaceObjectModel) mit den SFML-Darstellungsklassen wie
 * Sprite und Texture. Im Code muss also nur ein SpaceObject erstellt werden, die immer dazugeh√∂rigen
...
public class SpaceObject {
	...
	public SpaceObjectModel model;	/**< @brief Model (f√ºr Berechnungen) des Spaceobjects */
	...
	/**
	 * @brief Konstruktor
	 * @param texturePath Pfad zur Textur, die f√ºr das SpaceObject verwendet werden soll
	 ...
	 * Ansatz: Um die W‰nde ¸berpr¸fen zu kˆnnen ¸berpr¸fen wir die 4 Tiles,
	 ...
	 * werden die neuen 4 Tiles ¸berpr¸ft.
	...
	/**
	 * @brief F√ºgt dem Objekt an Rotationsgeschwindigkeit hinzu, d.h., beschleunigt das Objekt in der Rotation
	 * @param am Zus√§tzliche Rotationsgeschwindigkeit [Grad/s]
	 */
	...
	/**
	 * @brief getter f√ºr angularMomentum
	...
	/**
	 * @brief getter f√ºr verwendetes Sprite
